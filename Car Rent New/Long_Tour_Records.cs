    ...
    public partial class Long_Tour_Records : Form
    {
        ...
        private void loadTable()
        {
            try
            {
                ...
                cmd.CommandText = "SELECT * FROM Long_Tour_tbl";
                cmd.ExecuteNonQuery();
